...
class LRU():
    ...
    def add_page_or_update(self, mem_address):
        ...
        if self.frame_queue.update_successful(vpn, read_or_write) == True:
            ...
            if self.frame_queue.add_successful(vpn, read_or_write) == False:
                ...
                self.frame_queue.add_successful(vpn, read_or_write)
